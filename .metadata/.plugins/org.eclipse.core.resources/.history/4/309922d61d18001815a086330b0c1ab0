...
public class Base {
	...
	public static JFormattedTextField cash_field = new JFormattedTextField();
	...
	public static void addComponents() {
		cash_field.setDocument(
	            new PlainDocument() {
	              public void insertString(int offset, String string, AttributeSet attributeSet ) throws BadLocationException {
	                  String new_string = "";
	                  for (int i = 0; i < string.length(); i ++) {
	                	  if (chars.contains(Character.toString(string.charAt(i)))) {
	                		  if (!(cash_field.getText().contains(".") && string.contains("."))) {
	                  ...
	                  super.insertString( offset, new_string, attributeSet );
	              }
	            }
	        );
